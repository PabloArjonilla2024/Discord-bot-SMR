...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addStringOption(option => option
      ...
      .setRequired(true)),
  category: "unosmr",
  usage: "Realizar una operación de resta",
  n: "</resta:1276173927852544058>",
    ...
    switch (baseSeleccionada) {
      case 'binario':
        await interaction.reply({
          embeds: [new EmbedBuilder()
            .setDescription(`El resultado de la resta en binario es: ${resultadoDecimal.toString(2)}`)
            .setColor("Green")
            .setTimestamp()
            .setFooter({ text: 'Bot realizado por ACPARJO', iconURL: client.user.displayAvatarURL() })
          ], ephemeral: false
      ...
      case 'decimal':
        await interaction.reply({
          embeds: [new EmbedBuilder()
            .setDescription(`El resultado de la resta en decimal es: ${resultadoDecimal}`)
            .setColor("Green")
            .setTimestamp()
            .setFooter({ text: 'Bot realizado por ACPARJO', iconURL: client.user.displayAvatarURL() })
          ], ephemeral: false
      ...
      case 'hexadecimal':
        await interaction.reply({
          embeds: [new EmbedBuilder()
            .setDescription(`El resultado de la resta en hexadecimal es: ${resultadoDecimal.toString(16)}`)
            .setColor("Green")
            .setTimestamp()
            .setFooter({ text: 'Bot realizado por ACPARJO', iconURL: client.user.displayAvatarURL() })
          ], ephemeral: false
      ...
      case 'octal':
        await interaction.reply({
          embeds: [new EmbedBuilder()
            .setDescription(`El resultado de la resta en octal es: ${resultadoDecimal.toString(8)}`)
            .setColor("Green")
            .setTimestamp()
            .setFooter({ text: 'Bot realizado por ACPARJO', iconURL: client.user.displayAvatarURL() })
          ], ephemeral: false
